...
public class AgileExceptionUtil {
    ...
    public static String getMessage(Throwable e) {
        if (null == e) {
            return AgileStringUtil.NULL;
        }
        return AgileStringUtil.format("{}: {}", e.getClass().getSimpleName(), e.getMessage());
    }
    ...
    public static String getSimpleMessage(Throwable e) {
        return (null == e) ? AgileStringUtil.NULL : e.getMessage();
    }
    ...
    public static String stacktraceToOneLineString(Throwable throwable, int limit) {
        ...
        replaceCharToStrMap.put(AgileCharUtil.CR, AgileStringUtil.SPACE);
        replaceCharToStrMap.put(AgileCharUtil.LF, AgileStringUtil.SPACE);
        replaceCharToStrMap.put(AgileCharUtil.TAB, AgileStringUtil.SPACE);
    ...
    public static String stacktraceToString(Throwable throwable, int limit, Map<Character, String> replaceCharToStrMap) {
        if (throwable != null) {
            ...
            if (replaceCharToStrMap != null && !replaceCharToStrMap.isEmpty()) {
                ...
                return exceptionStr.substring(0,length);
            }
        } else {
            return null;
        }
    ...
    public static <T extends Throwable> T convertFromOrSuppressedThrowable(Throwable throwable, Class<T> exceptionClass, boolean checkCause) {
        ...
        if (AgileArrayUtil.isNotEmpty(throwables)) {
