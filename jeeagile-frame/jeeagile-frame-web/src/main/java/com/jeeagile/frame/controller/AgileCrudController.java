...
public abstract class AgileCrudController<I extends IAgileBaseService<T>, T extends AgileModel> extends AgileBaseController {
    ...
    @AgileLogger(notes = "根据条件分页查询数据", type = AgileOperateType.SELECT)
    ...
    @AgileLogger(notes = "根据条件查询数据", type = AgileOperateType.SELECT)
    ...
    @AgileLogger(notes = "根据主键查看明细", type = AgileOperateType.DETAIL)
    ...
    @AgileLogger(notes = "新增数据", type = AgileOperateType.ADD)
    ...
    @AgileLogger(notes = "根据主键更新数据", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "根据主键删除数据", type = AgileOperateType.DELETE)
    ...
    @AgileLogger(notes = "导入数据", type = AgileOperateType.IMPORT)
