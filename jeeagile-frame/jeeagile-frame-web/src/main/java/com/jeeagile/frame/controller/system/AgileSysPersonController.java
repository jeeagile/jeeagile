...
public class AgileSysPersonController extends AgileBaseController {
    ...
    @AgileLogger(notes = "更新个人信息", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "更新个人密码", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "上传头像", type = AgileOperateType.UPDATE)
