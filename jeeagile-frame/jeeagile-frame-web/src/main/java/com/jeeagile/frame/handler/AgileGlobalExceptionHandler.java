...
public class AgileGlobalExceptionHandler {
    ...
    public <T> AgileResult<T> runtimeExceptionHandler(RuntimeException ex) {
        ...
        if (ex.getCause() instanceof AgileBaseException) {
            return rtnAgileResult((AgileBaseException) ex.getCause());
        }
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统运行异常！");
    }
    ...
    public <T> AgileResult<T> nullPointerExceptionHandler(NullPointerException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生空指针异常！");
    }
    ...
    public <T> AgileResult<T> classCastExceptionHandler(ClassCastException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生类型转换异常！");
    }
    ...
    public <T> AgileResult<T> iOExceptionHandler(IOException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生IO异常！");
    }
    ...
    public <T> AgileResult<T> indexOutOfBoundsExceptionHandler(IndexOutOfBoundsException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生数组越界异常！");
    }
    ...
    public <T> AgileResult<T> dataParseException(HttpMessageNotReadableException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生数据转换异常！");
    }
    ...
    public <T> AgileResult<T> jsonParseException(JSONException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "JSON数据库格式化异常！");
    }
    ...
    public <T> AgileResult<T> noSuchMethodExceptionHandler(NoSuchMethodException ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "未知方法异常！");
    }

    //自定义异常
    @ExceptionHandler({AgileBaseException.class})
    public <T> AgileResult<T> agileBaseException(AgileBaseException ex) {
        logger.warn("系统发生自定义异常，异常信息：{}", ex.getMessage());
        return rtnAgileResult(ex);
    }
    ...
    public <T> AgileResult<T> exception(Exception ex) {
        ...
        return rtnAgileResult(AgileResultCode.FAIL_SERVER_EXCEPTION, "系统发生未知错误异常！");
    }

    private <T> AgileResult<T> rtnAgileResult(AgileBaseException ex) {
        return rtnAgileResult(ex.getAgileResultCode(), ex.getMessage());
    }

    private <T> AgileResult<T> rtnAgileResult(IAgileResultCode agileResultCode, String message) {
