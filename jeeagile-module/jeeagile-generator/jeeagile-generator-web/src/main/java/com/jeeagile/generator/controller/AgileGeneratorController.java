...
public class AgileGeneratorController extends AgileBaseController {
    ...
    public AgileResult<AgilePage<AgileGeneratorTable>> selectTablePage(@RequestBody AgilePageable<AgileGeneratorTable> agilePageable) {
        return this.success(agileGeneratorTableService.selectTablePage(agilePageable));
    }
    ...
    public AgileResult<AgilePage<AgileGeneratorTable>> selectDbTablePage(@RequestBody AgilePageable<AgileGeneratorTable> agilePageable) {
        return this.success(agileGeneratorTableService.selectDbTablePage(agilePageable));
    }

    @PostMapping("/importTable")
    @ApiOperation(value = "导入代码生成", notes = "导入代码生成")
    @AgileLogger(notes = "导入代码生成", type = AgileOperateType.IMPORT)
    ...
    @AgileLogger(notes = "修改代码生成表信息", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "删除代码生成表信息", type = AgileOperateType.DELETE)
    ...
    @AgileLogger(notes = "同步代码生成表信息", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "预览生成代码", type = AgileOperateType.GENERATOR)
    ...
    @AgileLogger(notes = "下载生成代码", type = AgileOperateType.GENERATOR)
