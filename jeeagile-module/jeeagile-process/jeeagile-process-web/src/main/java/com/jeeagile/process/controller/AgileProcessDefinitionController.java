...
public class AgileProcessDefinitionController extends AgileCrudController<IAgileProcessDefinitionService, AgileProcessDefinition> {
    ...
    @AgileLogger(notes = "流程定义激活", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "流程定义挂起", type = AgileOperateType.UPDATE)
    ...
    @AgileLogger(notes = "设置主版本", type = AgileOperateType.UPDATE)
