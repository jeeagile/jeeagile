...
public class AgileQuartzLoggerController extends AgileBaseController {
    ...
    @AgileLogger(notes = "分页查询任务执行日志", type = AgileOperateType.SELECT)
    ...
    @AgileLogger(notes = "查看任务执行日志详细信息", type = AgileOperateType.DETAIL)
    ...
    @AgileLogger(notes = "删除任务执行日志数据", type = AgileOperateType.DELETE)
    ...
    @AgileLogger(notes = "清空任务执行日志记录", type = AgileOperateType.CLEAR)
