...
public abstract class AbstractAgileBeanPostProcessor implements MergedBeanDefinitionPostProcessor, Ordered,
        BeanFactoryAware, BeanClassLoaderAware, EnvironmentAware, DisposableBean, InstantiationAwareBeanPostProcessor {
    ...
    private final ConcurrentMap<String, AbstractAgileBeanPostProcessor.AnnotatedInjectionMetadata> injectionMetadataCache =
            new ConcurrentHashMap<String, AbstractAgileBeanPostProcessor.AnnotatedInjectionMetadata>(CACHE_SIZE);
     ...
     */
    public AbstractAgileBeanPostProcessor(Class<? extends Annotation>... annotationTypes) {
     ...
     */
    private List<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> findFieldAnnotationMetadata(final Class<?> beanClass) {

        final List<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> elements = new LinkedList<AbstractAgileBeanPostProcessor.AnnotatedFieldElement>();
     ...
     * @return non-null {@link List}
     */
    private List<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> findAnnotatedMethodMetadata(final Class<?> beanClass) {

        final List<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> elements = new LinkedList<AbstractAgileBeanPostProcessor.AnnotatedMethodElement>();
    ...
    private AbstractAgileBeanPostProcessor.AnnotatedInjectionMetadata buildAnnotatedMetadata(final Class<?> beanClass) {
        Collection<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> fieldElements = findFieldAnnotationMetadata(beanClass);
        Collection<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> methodElements = findAnnotatedMethodMetadata(beanClass);
    ...
    protected AnnotatedInjectionMetadata findInjectionMetadata(String beanName, Class<?> clazz, PropertyValues pvs) {
        ...
        AbstractAgileBeanPostProcessor.AnnotatedInjectionMetadata metadata = this.injectionMetadataCache.get(cacheKey);
    ...
    protected static class AnnotatedInjectionMetadata extends InjectionMetadata {
        ...
        private final Collection<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> fieldElements;

        private final Collection<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> methodElements;

        public AnnotatedInjectionMetadata(Class<?> targetClass, Collection<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> fieldElements,
                                          Collection<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> methodElements) {
        ...
        public Collection<AbstractAgileBeanPostProcessor.AnnotatedFieldElement> getFieldElements() {
            return fieldElements;
        }

        public Collection<AbstractAgileBeanPostProcessor.AnnotatedMethodElement> getMethodElements() {
