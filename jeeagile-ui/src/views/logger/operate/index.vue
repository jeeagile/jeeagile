<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleClean" v-hasPerm="['logger:operate:clear']">
          清空
        </el-button>
      </el-col>
      <right-toolbar :show-search.sync="showSearch" @queryTable="getLogList"/>
    </el-row>
    ...
    <!-- 分页 -->
    <pagination v-show="queryParam.pageTotal>0" :total-page="queryParam.pageTotal" :current-page.sync="queryParam.currentPage" :limit.sync="queryParam.pageSize" @pagination="getLogList"/>
...
<script>
  import { selectLogPage, deleteLog, cleanLog } from '@/api/logger/logger'
  ...
  export default {
    ...
    methods: {
      ...
      getLogList() {
        this.loading = true
        selectLogPage(this.queryParam).then(response => {
