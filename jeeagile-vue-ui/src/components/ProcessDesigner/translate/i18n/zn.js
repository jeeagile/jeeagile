export default {
  ...
  'Process started': '流程开始',
  'bpmn:Collaboration': '协作',
  'bpmn:Process': '流程',
  'bpmn:StartEvent': '{eventName}开始事件',
  'bpmn:IntermediateThrowEvent': '中间{eventName}抛出事件',
  'bpmn:IntermediateCatchEvent': '中间{eventName}捕获事件',
  'bpmn:Task': '任务',
  'bpmn:SendTask': '发送任务',
  ...
  'bpmn:CallActivity': '引用流程',
  'bpmn:EndEvent': '结束{eventName}事件',
  ...
  'bpmn:LinkEventDefinition': '链接',
  'bpmn:CompensateEventDefinition': '补偿',
  'bpmn:ErrorEventDefinition': '错误',
  'bpmn:TerminateEventDefinition': '边界',
  'bpmn:TextAnnotation': '文本解释',
  'bpmn:Association': '结合关系'
}
