      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="绑定列字段" prop="columnId">
            <el-select class="input-item" v-model="formData.columnId" :clearable="true" placeholder="字段数据表"
                       @change="onColumnChange">
              <el-option v-for="column in getTableColumnList" :key="column.columnId" :label="column.columnName"
        ...
        <el-col :span="24">
          <el-form-item label="表格列名" prop="showName">
            <el-input class="input-item" v-model="formData.showName" :clearable="true" placeholder="表格列名"/>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="表格列宽" prop="columnId">
            <el-input-number class="input-item" v-model="formData.columnWidth" placeholder="表格列宽"/>
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
          <el-form-item label="显示位置" prop="columnAlign">
            <el-radio-group v-model="formData.columnAlign">
        ...
        <el-col :span="24">
          <el-form-item label="支持排序" prop="sortable">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          columnAlign: [
            { required: true, message: '表格列显示位置不能为空', trigger: 'blur' }
          ],
          sortable: [
            { required: true, message: '表格列是否排序不能为空', trigger: 'blur' }
          ]
        }
      }
    },
    methods: {
      ...
      onSubmit() {
        this.$refs.form.validate(valid => {
          ...
          this.formData.tableType = this.getCurrentTable.tableType
          this.onCancel(true)
        })
      },
      onTableChange() {
      ...
      onColumnChange() {
        ...
        this.formData.showName = this.formData.onlineColumn ? this.formData.onlineColumn.fieldLabel : undefined
      }
    },
    computed: {
      getCurrentTable() {
