...
<script>
  ...
  import { detailProcess, saveProcessXml } from '@/api/process/designer'
  ...
  export default {
    ...
    created() {
      ...
      this.detailProcess(processId)
    },
    methods: {
      detailProcess(processId) {
        detailProcess(processId).then(response => {
          this.processInfo.processId = response.data.id
          this.processInfo.processCode = response.data.processCode
          this.processInfo.processName = response.data.processName
