...
drop table if exists agile_process_designer;
drop table if exists agile_process_definition;
drop table if exists agile_process_order;
...
/*==============================================================*/
/* table: agile_process_designer 流程表                             */
/*==============================================================*/
CREATE TABLE agile_process_designer
(
    id                varchar(32)  NOT NULL COMMENT '流程主键ID',
    process_code      varchar(20)  NOT NULL COMMENT '流程编码',
    process_name      varchar(100) NOT NULL COMMENT '流程名称',
    process_version   int          NOT NULL COMMENT '版本',
...
alter table agile_process_designer comment '流程表';
...
(
    ...
    process_id         varchar(32)  NOT NULL COMMENT '流程主键ID',
    process_code       varchar(20)  NOT NULL COMMENT '流程编码',
    process_name       varchar(100) NOT NULL COMMENT '流程名称',
...
/*==============================================================*/
/* table: agile_process_order   流程实例表                        */
/*==============================================================*/
CREATE TABLE agile_process_order
(
    id               varchar(32)  NOT NULL COMMENT '工单ID',
    process_id       varchar(32)  NOT NULL COMMENT '流程主键ID',
    process_code     varchar(20)  NOT NULL COMMENT '流程编码',
    process_name     varchar(100) NOT NULL COMMENT '流程名称',
    process_xml      text         NOT NULL COMMENT '流程设计XMl',
    definition_id    varchar(100) NOT NULL COMMENT '流程定义ID',
    instance_id      varchar(100) NOT NULL COMMENT '流程实例ID',
    form_type        varchar(32)  NOT NULL COMMENT '流程表单类型',
    form_name        varchar(100) NOT NULL COMMENT '表单名称',
    form_conf        text DEFAULT NULL COMMENT '流程表单配置',
    form_fields      text DEFAULT NULL COMMENT '流程表单字段',
    form_data        text DEFAULT NULL COMMENT '流程表单数据',
    form_url         varchar(32)  DEFAULT NULL COMMENT '流程表单地址',
...
INSERT INTO agile_sys_dict_data VALUES ('131', '0', 0, '流程表单', '01', 'process_form_type', '0', '0', NULL, NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_dict_data VALUES ('132', '0', 1, '业务表单', '02', 'process_form_type', '0', '0', NULL, NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_dict_data VALUES ('133', '0', 1, '在线表单', '03', 'process_form_type', '0', '0', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO agile_sys_menu VALUES ('60101', '601', '流程表单明细', 1, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:detail', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60102', '601', '流程表单新增', 2, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:add', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60103', '601', '流程表单修改', 3, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:update', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60104', '601', '流程表单删除', 4, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:delete', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60105', '601', '流程表单导入', 5, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:import', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60106', '601', '流程表单导出', 6, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:export', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60107', '601', '流程表单预览', 7, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:view', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60108', '601', '流程表单设计', 8, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:form:designer', '', NULL, NULL, NULL, NULL);

INSERT INTO agile_sys_menu VALUES ('602', '6', '流程设计', '1', 'process/designer/index', 'model', 'example', 'C', '0', '0', '0', '01', '', '', 'process:designer:page,process:designer:list', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60201', '602', '流程明细', 1, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:detail', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60202', '602', '流程新增', 2, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:add', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60203', '602', '流程修改', 3, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:update', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60204', '602', '流程删除', 4, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:delete', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60205', '602', '流程导入', 5, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:import', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60206', '602', '流程导出', 6, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:export', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60207', '602', '流程预览', 7, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:view', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60208', '602', '流程设计', 8, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:designer:xml', '', NULL, NULL, NULL, NULL);

INSERT INTO agile_sys_menu VALUES ('603', '6', '流程表达式', '1', 'process/expression/index', 'expression', 'expression', 'C', '0', '0', '0', '01', '', '', 'process:expression:page,process:expression:list', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60301', '603', '流程表达式明细', 1, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:detail', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60302', '603', '流程表达式新增', 2, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:add', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60303', '603', '流程表达式修改', 3, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:update', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60304', '603', '流程表达式删除', 4, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:delete', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60305', '603', '流程表达式导入', 5, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:import', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('60306', '603', '流程表达式导出', 6, '', '', '#', 'F', '0', '0', '0', '', '', '', 'process:expression:export', '', NULL, NULL, NULL, NULL);

INSERT INTO agile_sys_menu VALUES ('7', '0', '我的事务', '0', '', 'process/task', 'education', 'M', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('701', '7', '流程发起', '1', 'process/task/start', 'start', 'edit', 'C', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('702', '7', '我的待办', '2', 'process/task/todo', 'todo', 'message', 'C', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('703', '7', '我的已办', '3', 'process/task/done', 'done', 'clipboard', 'C', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, NULL);
INSERT INTO agile_sys_menu VALUES ('704', '7', '我的发起', '4', 'process/task/apply', 'apply', 'button', 'C', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, NULL);
