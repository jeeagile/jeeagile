...
/*==============================================================*/
/* table: agile_process_instance 流程定义表                      */
/*==============================================================*/
CREATE TABLE agile_process_instance (
  ...
  deployment_time               datetime DEFAULT NULL COMMENT '流程部署时间',
  definition_id                 varchar(100) DEFAULT NULL COMMENT '流程定义ID（流程组件生成）',
  instance_id                   varchar(100) DEFAULT NULL COMMENT '流程实例ID（流程组件生成）',
  instance_status               varchar(2) DEFAULT NULL COMMENT '流程实例状态（1：正在办理中）',
  suspension_state              int NOT NULL COMMENT '挂起状态',
  start_user                    varchar(32) NOT NULL COMMENT '流程实例发起人',
  start_time                    datetime DEFAULT NULL COMMENT '程实例启动时间',
  end_time                      datetime DEFAULT NULL COMMENT '程实例结束时间',
  create_user                   varchar(32) DEFAULT NULL COMMENT '创建人',
  create_time                   datetime DEFAULT NULL COMMENT '创建时间',
  update_user                   varchar(32) DEFAULT NULL COMMENT '修改人',
  update_time                   datetime DEFAULT NULL COMMENT '修改时间',
